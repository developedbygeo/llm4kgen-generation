import { ArtworkMappingsParameterMapping } from '../outputMappings/ArtworkMappingsParameterMapping';

export const initialArtworkConnector = (
    query: string
): keyof typeof ArtworkMappingsParameterMapping => {
